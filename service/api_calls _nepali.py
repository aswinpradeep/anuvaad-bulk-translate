                        ...
                        "files": [
                            {
                                ...
                                "locale": "en",
                                "model": {
                                    "uuid": "18311069-766f-4550-b756-628bd518d5c6",
                                    "is_primary": True,
                                    "model_id": 250,
                                    "model_name": "English-Nepali IndicTrans Model-2",
                                    "source_language_code": "en",
                                    "source_language_name": "English",
                                    "target_language_code": "ne",
                                    "target_language_name": "Nepali (Alpha)",
                                    "description": "AAI4B en-ne model-2(indictrans/fairseq)",
                                    "status": "ACTIVE",
                                    "connection_details": {
                                        "kafka": {
